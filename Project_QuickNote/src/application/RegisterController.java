...
public class RegisterController implements Initializable{
	...
	@FXML
	private ImageView iconSignin; // Image of an icon.
	
	@FXML
	private Button closeButtonS; // Button to close the application.
	
	@FXML
	private Label correctMessageSignIn; // Variable that represents a message when the user has successfully registered.
	
	@FXML
	private Label signinMessage; // Variable representing an error message.
	
	@FXML
	private TextField firstnameSignin; // The first username.
	
	@FXML 
	private TextField usernameSignin; // The username you want to type.
	
	@FXML
	private TextField emailSignin; // The email.
	
	@FXML
	private PasswordField passwordSignin; // The user's password.
	
	@FXML
	private PasswordField confirmPasswordSignin; // Para confirmar que la contraseña es validad.
